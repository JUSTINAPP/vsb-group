      ...
      <main>
        ...
        <section className="bg-white py-[48px] md:py-[64px]">
          <div className="max-w-3xl mx-auto px-6 md:px-[60px]">
            ...
            <div className="text-[13px] leading-[1.9] text-warm font-sans font-light space-y-8">

              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">1. Who we are</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">2. Information we collect</h3>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">3. How we use your information</h3>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">4. Disclosure of your information</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">5. Data security</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">6. Cookies and analytics</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">7. Access and correction</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">8. Marketing communications</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">9. Third-party websites</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">10. Changes to this policy</h3>
                <p>
              ...
              <div>
                <h3 className="font-display uppercase tracking-tight font-semibold text-[22px] text-charcoal mb-3">11. Contact us</h3>
                <p>
                ...
                <div className="mt-4 bg-sky-light rounded-[4px] border-l-2 border-sky px-[18px] py-4">
                  <p className="font-sans font-light text-charcoal text-[13px] leading-[1.8]">
